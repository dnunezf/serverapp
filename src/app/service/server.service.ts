// in this class are the functions that we need to make hdb requests
...
export class ServerService {
  ...
  /* this is a procedural way to make requests to the backend
  ...
  get servers$(): Observable<CustomResponse> {
    return this.http
          ...
          : {
            ...
            message:
              response.data.servers.filter(
                ...
                ? `Servers filtered by 
          ${status === Status.SERVER_UP ? 'SERVER UP' : 'SERVER_DOWN'} status`
